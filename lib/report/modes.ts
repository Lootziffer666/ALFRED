...
export const REPORT_MODES: Record<ReportMode, ReportModeSpec> = {
  pruefbericht: {
    ...
    defaultLevel: 1,
    sections: ["opening", "technical-quirks", "institutional-oddities", "contradictions", "evidence"],
    status: "implemented",
  },
  biografie: {
    id: "biografie",
    ...
    defaultLevel: 2,
    sections: ["opening", "former-identity", "actual-outcome", "contradictions", "evidence"],
    status: "planned",
  },
  roast: {
    id: "roast",
    ...
    defaultLevel: 4,
    sections: ["opening", "technical-quirks", "institutional-oddities", "surprising-strengths", "contradictions", "evidence"],
    status: "planned",
  },
};
